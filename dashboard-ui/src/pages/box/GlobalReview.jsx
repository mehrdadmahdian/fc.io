...
function GlobalReview() {
        ...
        const fetchReviewData = async () => {
            try {
                ...
                if (response.data.status === 'success') {
                    ...
                    setError('Failed to fetch global review data');
                }
            } catch (err) {
    ...
    const handleResponse = async (difficulty) => {
        try {
            ...
            await api.post(`/dashboard/boxes/${currentCardData.BoxID}/review/respond`, {
            ...
            if (currentCard < totalCards - 1) {
                ...
                alert(`Global review completed! You've reviewed ${currentCard + 1} cards from all your boxes.`);
                navigate('/');
            }
        } catch (err) {
            setError(err.message);
