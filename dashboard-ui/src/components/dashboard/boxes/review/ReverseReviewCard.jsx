    ...
    return (
        <div className="review-section">
            ...
            <div className="main-content">
                <div 
                    className={`review-card reverse-mode ${showAnswer ? 'show-answer' : ''}`} 
                ...
                >
                    <div className="card-content">
                        <div className={`card-face ${showAnswer ? 'front' : 'back'}`}>
                            {!showAnswer ? (
                                <div className="question">
                                    <div className="question-text">
                                        <MarkdownContent content={card.Back} className="review-question-content" />
                                    </div>
                                    <div className="reverse-indicator">
                                        <span className="mode-badge">Reverse Mode</span>
                                    </div>
                                </div>
                            ) : (
                                <div className="answer">
                                    <div className="answer-main">
                                        <div className="answer-text">
                                            <MarkdownContent content={card.Front} className="review-answer-content" />
                                        </div>
                                    </div>
